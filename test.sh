...
# curl -X POST -H "Content-Type: application/json" -d '{"topic_name":"example_topic1", "producer_id":2, "log_message":"example log message 2"}' http://localhost:5000/producer/produce
